...
| 📅 **기 간** | 🏢 **기관 / 소속명** | 📝 **활동 내용** |
|:--:|:--:|:--:|
| 2023.05 | 단국대학교 | **알림어플(Reminder App) 개발 프로젝트** — 위치·날씨 기반 알림 어플 프로토타입 구현 <br>  [Python 코드 보기](./reminder_app.py) |
| 2024.07 ~ 2024.08 | 안산시청 | **청년 유입 분석 공모전** — 지하철역별 교통·치안·편의시설 데이터 기반 청년 친화도·발전잠재력 점수화 <br>  [Notion 페이지](https://www.notion.so/21ee763f720a80fc9e7aea0f4bcc515a) |
| 2025.04 ~ 2025.06 | 단국대학교 | **헬스케어 빅데이터 프로젝트** — ADHD 약물 효과 분석 및 인과추정(PSM·IPTW) 수행 <br>  [R 코드 보기](./헬스케어_예측모델.R) |
